...
$lkey=$_SESSION['key'];
$myquery="select * from admin where SECRET='$lkey'";
                                        ...
                                        <tbody>
                                            ...
                                            while($res=mysqli_fetch_array($result)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="print.php?id=<?php echo $res['ID'] ?>" target="_blank" class="btn btn-primary"><span class="glyphicon glyphicon-print"></span>&nbsp;Print</a></td>
